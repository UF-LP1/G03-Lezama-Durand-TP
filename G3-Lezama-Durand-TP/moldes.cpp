 ...
 * @param marca
 */
moldes::moldes(string nom, enum tipo clasificacion, unsigned int tamanio, string material, unsigned int stock, unsigned int cod,
    unsigned int precio, string marca) :Reposteria(nom, stock, cod, marca, precio) {
