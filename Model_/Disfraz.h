...
public:
     ...
     * @param marca
     */
    Disfraz(bool alquila, const unsigned int codigo_de_disfraz, string tipo, char talle, bool encarga, string fecha_alquilar, string fecha_retorno, unsigned int codigo, unsigned int stock, unsigned int precio, string marca);
    ~Disfraz();
